...
//go:generate minimock -i github.com/en7ka/auth/internal/service/servinterface.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
// UserServiceMock implements mm_servinterface.UserService
type UserServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreate          func(ctx context.Context, info *models.UserInfo) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, info *models.UserInfo)
	...
	funcUpdate          func(ctx context.Context, id int64, info *models.UserInfo) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, id int64, info *models.UserInfo)
	afterUpdateCounter  uint64
	beforeUpdateCounter uint64
	UpdateMock          mUserServiceMockUpdate
}

// NewUserServiceMock returns a mock for mm_servinterface.UserService
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, info *models.UserInfo) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) ExpectInfoParam2(info *models.UserInfo) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, info *models.UserInfo)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, info *models.UserInfo) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, info *models.UserInfo) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
// Create implements mm_servinterface.UserService
func (mmCreate *UserServiceMock) Create(ctx context.Context, info *models.UserInfo) (i1 int64, err error) {
...
// Delete implements mm_servinterface.UserService
...
func (mmGet *mUserServiceMockGet) Return(up1 *models.User, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (up1 *models.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(up1 *models.User, err error) *UserServiceMock {
...
// Get implements mm_servinterface.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (up1 *models.User, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, id int64, info *models.UserInfo) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) ExpectInfoParam3(info *models.UserInfo) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, id int64, info *models.UserInfo)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, id int64, info *models.UserInfo) (err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, id int64, info *models.UserInfo) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
// Update implements mm_servinterface.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, id int64, info *models.UserInfo) (err error) {
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter info, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
