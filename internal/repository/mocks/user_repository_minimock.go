...
//go:generate minimock -i github.com/en7ka/auth/internal/repository/repositoryinterface.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
// UserRepositoryMock implements mm_internal.UserRepository
...
// NewUserRepositoryMock returns a mock for mm_internal.UserRepository
...
// Create implements mm_internal.UserRepository
...
// Delete implements mm_internal.UserRepository
...
// Get implements mm_internal.UserRepository
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, id int64, info *model.UserInfo) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInfoParam3(info *model.UserInfo) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, id int64, info *model.UserInfo)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, id int64, info *model.UserInfo) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, id int64, info *model.UserInfo) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
// Update implements mm_internal.UserRepository
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, id int64, info *model.UserInfo) (err error) {
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.info != nil && !minimock.Equal(*mm_want_ptrs.info, mm_got.info) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter info, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
