...
//go:generate minimock -i github.com/en7ka/auth/internal/client/db.TxManager -o tx_manager_mock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/en7ka/auth/internal/client/db"
