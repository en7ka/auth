...
const (
	UserAPI_Create_FullMethodName         = "/api.user_v1.UserAPI/Create"
	UserAPI_Get_FullMethodName            = "/api.user_v1.UserAPI/Get"
	UserAPI_GetByUsername_FullMethodName  = "/api.user_v1.UserAPI/GetByUsername"
	UserAPI_GetByUsernames_FullMethodName = "/api.user_v1.UserAPI/GetByUsernames"
	UserAPI_Update_FullMethodName         = "/api.user_v1.UserAPI/Update"
	UserAPI_Delete_FullMethodName         = "/api.user_v1.UserAPI/Delete"
)
...
func (c *userAPIClient) GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, UserAPI_GetByUsername_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userAPIClient) GetByUsernames(ctx context.Context, in *GetByUsernamesRequest, opts ...grpc.CallOption) (*GetByUsernamesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetByUsernamesResponse)
	err := c.cc.Invoke(ctx, UserAPI_GetByUsernames_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserAPIServer) GetByUsername(context.Context, *GetByUsernameRequest) (*GetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByUsername not implemented")
}
func (UnimplementedUserAPIServer) GetByUsernames(context.Context, *GetByUsernamesRequest) (*GetByUsernamesResponse, error) {
...
func _UserAPI_GetByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAPI_GetByUsername_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserAPI_GetByUsernames_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByUsernamesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserAPIServer).GetByUsernames(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserAPI_GetByUsernames_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserAPIServer).GetByUsernames(ctx, req.(*GetByUsernamesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserAPI_GetByUsernames_Handler,
		},
		{
			MethodName: "Update",
	...
	Metadata: "api/proto/user_v1/user.proto",
}
