...
const file_api_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x1capi/proto/user_v1/user.proto\x12\vapi.user_v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x7f\n" +
	"\bUserInfo\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12%\n" +
	"\x04role\x18\x04 \x01(\x0e2\x11.api.user_v1.RoleR\x04role\"\xde\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12)\n" +
	"\x04info\x18\x02 \x01(\v2\x15.api.user_v1.UserInfoR\x04info\x12%\n" +
	"\x04role\x18\x03 \x01(\x0e2\x11.api.user_v1.RoleR\x04role\x129\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"~\n" +
	"\x0eUpdateUserInfo\x128\n" +
	...
	"\rCreateRequest\x12)\n" +
	"\x04info\x18\x01 \x01(\v2\x15.api.user_v1.UserInfoR\x04info\" \n" +
	...
	"\vGetResponse\x12%\n" +
	"\x04note\x18\x01 \x01(\v2\x11.api.user_v1.UserR\x04note\"P\n" +
	"\rUpdateRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12/\n" +
	"\x04info\x18\x02 \x01(\v2\x1b.api.user_v1.UpdateUserInfoR\x04info\"\x1f\n" +
	"\rDeleteRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id*\x1b\n" +
	"\x04Role\x12\b\n" +
	"\x04user\x10\x00\x12\t\n" +
	"\x05admin\x10\x01B*Z(github.com/en7ka/auth/pkg/user_v1;userv1b\x06proto3"
