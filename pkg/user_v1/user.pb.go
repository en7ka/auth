...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\vapi.user_v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xaa\x01\n" +
	"\bUserInfo\x12&\n" +
	"\busername\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xff\x01R\busername\x12\x1d\n" +
	"\x05email\x18\x02 \x01(\tB\a\xfaB\x04r\x02`\x01R\x05email\x12&\n" +
	"\bpassword\x18\x03 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x06\x18\xff\x01R\bpassword\x12/\n" +
	"\x04role\x18\x04 \x01(\x0e2\x11.api.user_v1.RoleB\b\xfaB\x05\x82\x01\x02\x10\x01R\x04role\"\xe8\x01\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12)\n" +
	"\x04info\x18\x02 \x01(\v2\x15.api.user_v1.UserInfoR\x04info\x12/\n" +
	"\x04role\x18\x03 \x01(\x0e2\x11.api.user_v1.RoleB\b\xfaB\x05\x82\x01\x02\x10\x01R\x04role\x129\n" +
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x129\n" +
	"\n" +
	"updated_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt\"\x93\x01\n" +
	"\x0eUpdateUserInfo\x12D\n" +
	"\busername\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueB\n" +
	"\xfaB\ar\x05\x10\x01\x18\xff\x01R\busername\x12;\n" +
	"\x05email\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueB\a\xfaB\x04r\x02`\x01R\x05email\"D\n" +
	"\rCreateRequest\x123\n" +
	"\x04info\x18\x01 \x01(\v2\x15.api.user_v1.UserInfoB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04info\" \n" +
	...
	"\vGetResponse\x12%\n" +
	"\x04note\x18\x01 \x01(\v2\x11.api.user_v1.UserR\x04note\"Z\n" +
	"\rUpdateRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x129\n" +
	"\x04info\x18\x02 \x01(\v2\x1b.api.user_v1.UpdateUserInfoB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04info\"\x1f\n" +
	"\rDeleteRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id*\x1b\n" +
	"\x04Role\x12\b\n" +
	"\x04user\x10\x00\x12\t\n" +
	"\x05admin\x10\x012\xe1\x02\n" +
	"\aUserAPI\x12]\n" +
	"\x06Create\x12\x1a.api.user_v1.CreateRequest\x1a\x1b.api.user_v1.CreateResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/user/v1/create\x12J\n" +
	"\x03Get\x12\x17.api.user_v1.GetRequest\x1a\x18.api.user_v1.GetResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/user/v1\x12S\n" +
	"\x06Update\x12\x1a.api.user_v1.UpdateRequest\x1a\x16.google.protobuf.Empty\"\x15\x82\xd3\xe4\x93\x02\x0f\x12\r/user/v1/list\x12V\n" +
	"\x06Delete\x12\x1a.api.user_v1.DeleteRequest\x1a\x16.google.protobuf.Empty\"\x18\x82\xd3\xe4\x93\x02\x12:\x01*2\r/user/v1/{id}B\x91\x01\x92Ac\x12*\n" +
	"\bUser API\"\x1e\n" +
	"\x05en7ka\x1a\x15enikdamei1999@mail.ru\x1a\x0elocalhost:8080*\x01\x012\x10application/json:\x10application/jsonZ)github.com/en7ka/auth/pkg/user_v1;user_v1b\x06proto3"
...
var file_user_proto_goTypes = []any{
	...
	(*GetResponse)(nil),            // 7: api.user_v1.GetResponse
	(*UpdateRequest)(nil),          // 8: api.user_v1.UpdateRequest
	(*DeleteRequest)(nil),          // 9: api.user_v1.DeleteRequest
...
var file_user_proto_depIdxs = []int32{
	...
	9,  // 13: api.user_v1.UserAPI.Delete:input_type -> api.user_v1.DeleteRequest
	5,  // 14: api.user_v1.UserAPI.Create:output_type -> api.user_v1.CreateResponse
	7,  // 15: api.user_v1.UserAPI.Get:output_type -> api.user_v1.GetResponse
	12, // 16: api.user_v1.UserAPI.Update:output_type -> google.protobuf.Empty
	12, // 17: api.user_v1.UserAPI.Delete:output_type -> google.protobuf.Empty
